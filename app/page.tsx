...
initVoiceProctoring(stream, (reason, metadata) => {
  if (reason === "LATENT_SILENCE_DETECTED") {
    applyRiskAdjustment(5, "Voice Violation: Long silence detected");
  }

  if (reason === "UNNATURAL_MONOTONIC_VOICE") {
    applyRiskAdjustment(5, "Voice Violation: Monotonic speech detected");
  }
});
